...
intros.
apply (unfold_process Channel Act (REPEAT s)).
Qed.
...
Lemma SEND_UinvTC2 :
 forall (P : Prop) (v : bool) (q : Process) (b : bool) (s : Stream A),
 UnrelProcTrans Channel Act lnk2 (SEND b s)
   (Transmit _ Act lnk2 (Clear _ Act lnk2 v)) q -> P.
intros P v q b s.
rewrite (unfold_SEND b s).
intros H.
inversion H.
...
Lemma REPEAT_SinvT :
 forall (P : Signal _ Act del -> Process -> Stream A -> Prop)
   (w : Signal _ Act del) (q : Process) (s : Stream A),
 P (Clear _ Act del (hd s)) (REPEAT (tl s)) s ->
 SafeProcTrans Channel Act del (REPEAT s) (Transmit _ Act del w) q -> P w q s.
intros P w q s H.
...
Lemma REPEAT_UinvTC1 :
 forall (P : Prop) (w : Signal _ Act lnk1) (q : Process) (s : Stream A),
 UnrelProcTrans Channel Act lnk1 (REPEAT s) (Transmit _ Act lnk1 w) q -> P.
intros P w q s.
rewrite unfold_REPEAT.
intros H1.
inversion_clear H1.
...
Lemma REPEAT_UinvTC2 :
 forall (P : Prop) (w : Signal _ Act lnk2) (q : Process) (s : Stream A),
 UnrelProcTrans Channel Act lnk2 (REPEAT s) (Transmit _ Act lnk2 w) q -> P.
intros P w q s.
rewrite unfold_REPEAT.
intros H1.
inversion_clear H1.
